...
public class JobExecutorResourceAdapter implements ResourceAdapter {
	...
	private JobConfigurationAccessor jobConfiguration;
	...
	private void initConfiguration() {
		jobConfiguration = new JobConfigurationAccessor(JobExecutorResourceAdapter.class.getClassLoader()
				.getResourceAsStream(JobConfigurationAccessor.JOB_CONFIGURATION_LOCATION));
	}
	...
	private void initJobAcquisitions() {
		...
		for (JobConfigurationSection configuration : jobConfiguration.getSectionsMap().values()) {
